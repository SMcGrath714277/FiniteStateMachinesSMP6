...
public class Patrol: State
{
    ...
    public override void Enter()
    {
        ...
        for(int i = 0; i < GameEnviornment.Singleton.Checkpoints.Count; i++)
        {
            GameObject thisWP = GameEnviornment.Singleton.Checkpoints[i];
    ...
    public override void Update()
    {
        ...
        {
            if (currentIndex >= GameEnviornment.Singleton.Checkpoints.Count - 1)
                currentIndex = 0;
            else
                currentIndex++;
